...
//
//
//import com.thtf.common.entity.adminserver.TblOperateLog;
...
//@Service
//
//@FeignClient(value = "admin-server",url="10.10.82.82:8001")
////@FeignClient(value = "admin-server")
//@RequestMapping("/admin-server")
//public interface LocalAdminAPI {
//
//    /**
//     * 根据职位查询用户
//     *
...
//
//    @PostMapping("/basic/saveOperateLog")
//    ResponseEntity<com.thtf.common.response.JsonResult> saveOperateLog(TblOperateLog operateLog);
//}